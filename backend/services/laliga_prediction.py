...
from .la_liga_data import fetch_live_form
...
model_home = joblib.load(os.path.join(_MODELS_DIR, "Laliga_optimized_model_home.pkl"))
model_away = joblib.load(os.path.join(_MODELS_DIR, "Laliga_optimized_model_away.pkl"))
